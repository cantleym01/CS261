...
public class DeletePCB extends JMenuItem implements CommandPCB
{
    ...
    public PCBList execute(PCBList list)
    {
        ...
        String message1 = "That PCB has not been deleted somehow.";
        String message2 = "That PCB has been deleted.";
        ...
        list.removePCB(list.FindPCB(ProcessName));
        
        if ("NULL".equals(list.FindPCB(ProcessName).processName)) //it has been deleted
        {
