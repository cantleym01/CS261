...
public class SuspendPCB extends JMenuItem implements CommandPCB
{
    ...
    public PCBList execute(PCBList list)
    {
        ...
        String message1 = "That PCB has not been suspended somehow.";
        String message2 = "That PCB has been suspended.";
        ...
        list.FindPCB(ProcessName).suspendedState = true; //suspend the PCB
        
        //see if the PCB has been suspended
        if (list.FindPCB(ProcessName).suspendedState == true) //it has been suspended
        {
