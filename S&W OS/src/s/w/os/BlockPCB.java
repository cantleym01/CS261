...
public class BlockPCB extends JMenuItem implements CommandPCB
{
    ...
    public PCBList execute(PCBList list)
    {
        ...
        list.insertPCBToQueue(1, tempPCB); //insert the tempPCB into the blocked queue
        
        //remove has been called, so as long as the PCB is found, it should be good
        if (ProcessName.equals(list.FindPCB(ProcessName).processName)) //it has been PCBlocked
        {
